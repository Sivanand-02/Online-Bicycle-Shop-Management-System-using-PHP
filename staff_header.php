		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light top-header">
			...
			<!-- 	<button class="navbar-toggler mx-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
					...
					<button class="btn btn-danger" style="margin-left:8em;">
							<a href="staff_home.php" style="color: white;">Home
					...
					<!-- <ul class="navbar-nav mx-auto"> -->
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_vendor.php">Manage Vendor
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_cust.php">Manage Customer
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_cat.php">Manage Category
								<span class="sr-only">(current)</span>
							</a>
						</li>	
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_subcat.php">Manage Subcategory
								<span class="sr-only">(current)</span>
							</a>
						</li>	
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_model.php">Manage Model
								<span class="sr-only">(current)</span>
							</a>
						</li>	
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_item.php">Manage Item
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_sales.php">Manage Sales
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="staff_manage_purchase.php">Manage Purchase 
								<span class="sr-only">(current)</span>
							</a>
						</li>
